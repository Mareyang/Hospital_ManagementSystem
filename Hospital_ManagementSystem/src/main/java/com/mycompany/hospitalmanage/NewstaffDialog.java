...
public class NewstaffDialog extends JDialog implements ActionListener {
    ...
    private JLabel lblTitle, lblSubtitle, lblBirth, lblEmpID, lblName, lblBday,lblGen,lblEmail, lblContact, 
    ...
    private JComboBox<String> cmbStatus, cmbGen, cmbMarital, cmbStats, cmbOff, cmbSRole, cmbSRate;
    ...
    NewstaffDialog() {
        ...
        JLabel lblDialogTitle = new JLabel("Staff Information");
